 ...
 * @author hehr
 */
public class AILocalHotWordIntent extends BaseIntent {
    ...
    /**
     * 后置filler缺少惩罚的置信度（float 默认 0.1）
     */
    private float omitConf = 0.1f;
    /**
     * 后置filler缺少的时间阈值（int 默认 550）
     */
    private int omitTime = 550;

    private boolean useOmitCheck = false;
