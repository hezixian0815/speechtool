...
/**
 * @deprecated {@link com.aispeech.lite.vprint.VprintConfig}
 */
@Deprecated
public class VprintConfig {
    ...
    public com.aispeech.lite.vprint.VprintConfig transferConfig() {
        return new com.aispeech.lite.vprint.VprintConfig.Builder()
                .setAsrppResBin(getAsrppResBin())
                .setUseDatabaseStorage(isUseDatabaseStorage(), getVprintDatabasePath())
                .setVprintResBin(getVprintResBin())
                .setVprintModelPath(getVprintModelPath())
                .create();
    }
}
